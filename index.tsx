...
import importedUsbCKicadMod from "./USB_C_Receptacle.kicad_mod"
...
export const Rp2040MinimalBoard = () => (
  <board pcbPack width="60mm" height="40mm">
    ...
    <chip
      name="J1"
      footprint={importedUsbCKicadMod}
    ...
    <pinheader
      ...
      schFacingDirection="right"
      pinLabels={[
        "GPIO29_ADC3", "GPIO29_ADC3",
        "GPIO28_ADC2", "GPIO28_ADC2",
        "GPIO27_ADC1", "GPIO27_ADC1",
        "GPIO26_ADC0", "GPIO26_ADC0",
        "GPIO25", "GPIO25",
        "GPIO24", "GPIO24",
        "GPIO23", "GPIO23",
        "GPIO22", "GPIO22",
